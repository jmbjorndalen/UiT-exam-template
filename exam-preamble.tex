...
\def\examNoScratch{NB! Det er ikke tillatt å levere inn kladdepapir som del av \vspace{0.2cm} \newline eksamensbesvarelsen. Hvis det likevel leveres inn, vil \vspace{0.2cm} \newline  kladdepapiret bli holdt tilbake og ikke bli sendt til sensur.}
...
\def\examNoScratch{NB! It is not allowed to submit scratch paper along with the answer sheets. If you do submit scratch paper, it will not be evaluated.}
...
\def\examContactName{Contact person during the exam}
\def\examMainTitle{EXAMINATION QUESTION \par PAPER} 
\def\examGuideTitle{ASSESSMENT GUIDELINE}
\def\examTPRhead{Faculty of Science and Technology} 
\def\examTypePaper{Type of \newline sheets \newline (squares/lines)}
...
\else        %------------------------------------------------------------ Exam --------
\begin{center}
{\fontsize{35}{50}\selectfont \textbf{ \examTitle}}
\end{center}
...
\examContactName:      & \examLecturer \\ \hline
...
\textbf{\Large \textcolor{red}{\examNoScratch}}
